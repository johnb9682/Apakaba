...
<div id="container">
    ...
    <nav>
    	<section class="nav_fix">
            ...
            <ul class="main-menu">
                ...
                <li class="current_page_item"><a href="blog-list.php">Blog</a>
                  <ul>
    ...
    <section class="page_title">
        <h1>Single Blog Page with Slider</h1>
        <h2>Blog Content with Comment Box</h2>
    </section><!-- /.page_title -->
                ...
                <section class="three_fourth content-left">
                    ...
                    <article class="post">
                    	<section class="meta">
                        	 ...
                        	 <span class="author">M. Zawistowicz</span>
                        	 <span class="tags"><a href="#">Layout</a>, <a href="">Design</a></span>
                        	 <a  href="#" class="comments">Comment 15</a>
                        </section><!-- /meta -->
                        
                    	<section class="post_content">
                        	<h1>Curabitur pharetra magna faucibus magna laoreet sit amet suscipit tellus vulputate.</h1>
                            <section class="media_container">
                            
                            	<section class="post_slider" id="post_slider_1">
                                      <div class="slides_container">
                                          <div><img src="images/banner/woman.jpg" width="510" height="272" alt="slider image" /></div>
                                          <div> <a href="#"><img src="images/banner/flex-banner.jpg" width="510" height="272" alt="slider image" /></a></div>
                                          <div><img src="images/banner/html5-banner.jpg" width="510" height="272" alt="slider image" /></div>
                                          <div><a href="#"><img src="images/banner/skins-banner.jpg" width="510" height="272" alt="slider image" /></a> </div>
                                       </div>
                                </section><!-- /.slides_container -->
            
                            </section><!-- /.media_container -->
                            
                            <p>
                           		 Nam sodales, lectus sed vulputate rhoncus, magna leo mollis tellus, quis commodo lectus enim eu ante. Nam consequat sagittis dui sed consequat. Nullam mollis metus ac leo sodales et eleifend lectus elementum. Praesent pretium, orci eget porttitor suscipit, elit sem iaculis arcu, sed porttitor felis orci ut orci. 
    					    </p>
                            <p>
								Vestibulum dictum, quam ac laoreet tincidunt, est lorem faucibus sapien, sit amet pulvinar dolor libero sit amet massa. Suspendisse potenti. Vivamus id volutpat dolor. 
							</p>
                             <br /><br />
                            
                            <div class="divider_2line"></div>
                            
                            <h3 id="comments">2 Responses to "Sample Post"</h3>
                            <ol class="commentlist">
                              <li class="comment even thread-even depth-1">
                                  <article id="li-comment-1628">
                                      <div class="comment-author vcard">
                                          <img alt="avatar" src="images/avatar.jpg" class="avatar avatar-40 photo" height="40" width="40" />                
                                          <div class="comment-meta"><a href=""><cite class="fn">Who know me</cite></a></div>
                                          <small>May 18, 2012</small>
                                      </div>
                                      <div class="clear_full"></div>
                                      
                                      <section class="comment-text clearfix">
                                      		<p>This website is really awesome. omg</p>
                                      </section>
                                      
                                      <div class="reply">
                                      <a class="comment-reply-link" href="/resources/sound-volume-sliders-free-psd-files/?replytocom=1628#respond" onclick='return addComment.moveForm("comment-1628", "1628", "respond", "569")'>Reply</a>	      
                                      </div>
                                  </article>
                                  <div class="clear_full"></div>
                              </li>
                          ...
                          <div id="respond">
                              ...
                              <p><textarea name="comment" id="comment" cols="500" rows="10" tabindex="4"></textarea></p>
                              <p><input name="submit" id="submit" tabindex="5" value="Publish" type="submit"></p>
                              </form>
                          </div><!-- /#respond -->
