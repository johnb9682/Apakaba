...
<div id="container">
    ...
    <nav>
    	<section class="nav_fix">
            ...
            <ul class="main-menu">
                ...
                <li class="current_page_item"><a href="typography.php">Typography</a>
                  <ul>
    ...
    <section class="page_title">
        <h1>Buttons and Message Samples</h1>
        <h2>A page with usefull styles</h2>
    </section><!-- /.page_title -->
	...
	<section id="content-container">
    	<section class="content_container_fix">
             ...
             <section class="full_width">
                ...
                <h2>Small Buttons</h2>
                <p>
                <a href="#" class="button button-small  black" target="_self"><span>Small Button</span></a>
                <a href="#" class="button button-small white" target="_self"><span>Small Button</span></a>
                <a href="#" class="button button-small green" target="_self"><span>Small Button</span></a>
                <a href="#" class="button button-small gray" target="_self"><span>Small Button</span></a>
                <a href="#" class="button button-small blue" target="_self"><span>Small Button</span></a>
                <a href="#" class="button button-small yellow" target="_self"><span>Small Button</span></a>
                <a href="#" class="button button-small orange" target="_self"><span>Small Button</span></a>
                <a href="#" class="button button-small violet" target="_self"><span>Small Button</span></a>
                <a href="#" class="button button-small brown" target="_self"><span>Small Button </span></a>
                <a href="#" class="button button-small red" target="_self"><span>Small Button</span></a>
                </p>
                </section>
                <section class="one_third">
                <h2>Standard Buttons</h2>
                <p>
                <a href="#" class="button  black" target="_self"><span>Standard Button</span></a>
                <a href="#" class="button white" target="_self"><span>Standard Button</span></a>
                <a href="#" class="button green" target="_self"><span>Standard Button</span></a>
                <a href="#" class="button gray" target="_self"><span>Standard Button</span></a>
                <a href="#" class="button blue" target="_self"><span>Standard Button</span></a>
                <a href="#" class="button yellow" target="_self"><span>Standard Button</span></a>
                <a href="#" class="button orange" target="_self"><span>Standard Button</span></a>
                <a href="#" class="button violet" target="_self"><span>Standard Button</span></a>
                <a href="#" class="button brown" target="_self"><span>Standard Button </span></a>
                <a href="#" class="button red" target="_self"><span>Standard Button</span></a>
                </p>
                </section>
                <section class="one_third last">
                <h2>Big Buttons</h2>
                <p>
                <a href="#" class="button  button-big  black" target="_self"><span>Big Button</span></a>
                <a href="#" class="button button-big white" target="_self"><span>Big Button</span></a>
                <a href="#" class="button button-big green" target="_self"><span>Big Button</span></a>
                <a href="#" class="button button-big gray" target="_self"><span>Big Button</span></a>
                <a href="#" class="button button-big blue" target="_self"><span>Big Button</span></a>
                <a href="#" class="button button-big yellow" target="_self"><span>Big Button</span></a>
                <a href="#" class="button button-big orange" target="_self"><span>Big Button</span></a>
                <a href="#" class="button button-big violet" target="_self"><span>Big Button</span></a>
                <a href="#" class="button button-big brown" target="_self"><span>Big Button </span></a>
                <a href="#" class="button button-big red" target="_self"><span>Big Button</span></a>
                </p>
                </section>
                ...
                <div class="message-box">
                    <p>Info - Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet d</p>
                </div><!-- /.message-box -->
                
                <div class="message-box green">
                    <p>Success Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat.</p>
                </div><!-- /.message-box -->
                
                <div class="message-box yellow">
                    <p>Notice Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat.</p>
                </div><!-- /.message-box -->
                
                <div class="message-box red">
                    <p>Error Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, quis nostrud exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea commodo consequat.</p>
                </div><!-- /.message-box -->
