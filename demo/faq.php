...
<div id="container">
    ...
    <section class="page_title">
        ...
        <h2>Are listed questions and answers</h2>
    </section>
    	...
    	<section class="content_container_fix">
          ...
          <section class="full_width">
           ...
           <section class="three_fourth content-left">
              ...
              <p>This is our FAQ's page where you will find answers to the most commonly asked questions.</p>
        
              <div id="accordion">
              
                  <div>
                      <h3><a href="#">Nunc venenatis viverra leo, ac hendrerit diam cursus sit amet ?</a></h3>
                      <div>
                      ...
                      <p> Suspendisse nec justo lorem. Integer viverra lorem ac ipsum tincidunt vitae molestie urna lobortis. Donec eget egestas neque. Suspendisse quis commodo orci. Nunc venenatis viverra leo, ac hendrerit diam cursus sit amet. Phasellus et molestie elit. Suspendisse potenti. Curabitur vel eleifend lorem. Nunc ut neque elit, id luctus lectus. Curabitur blandit bibendum cursus. Aenean at tortor magna, in hendrerit sem. Donec pellentesque diam sed magna interdum tempus ullamcorper metus ullamcorper. Suspendisse pulvinar lobortis elit a fermentum. Pellentesque aliquam suscipit gravida.</p>
                      </div>
                  </div>
                  
                  <div>
                      <h3><a href="#">Mauris pulvinar ultrices pellentesque. Phasellus eros sem, porta a imperdiet id, ultricies id diam ?</a></h3>
                      <div>
                      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer nec pellentesque lorem. Mauris pulvinar ultrices pellentesque. Phasellus eros sem, porta a imperdiet id, ultricies id diam. Nam quam urna, gravida a convallis nec, aliquam sit amet magna. Donec varius quam non lorem viverra vitae posuere enim sodales. Curabitur ut lacus non nisl bibendum vestibulum at id orci. Sed scelerisque ultricies dapibus. Nulla faucibus ante eget quam pellentesque eget fermentum magna consequat. Aenean lobortis sem at risus elementum suscipit. Suspendisse justo dui, sodales sit amet pharetra tristique, iaculis et nibh. Suspendisse potenti.
      
      In sit amet lacus nisl, at tempus tellus. Suspendisse nec justo lorem. Integer viverra lorem ac ipsum tincidunt vitae molestie urna lobortis. Donec eget egestas neque. Suspendisse quis commodo orci. Nunc venenatis viverra leo, ac hendrerit diam cursus sit amet. Phasellus et molestie elit. Suspendisse potenti. Curabitur vel eleifend lorem. Nunc ut neque elit, id luctus lectus. Curabitur blandit bibendum cursus. Aenean at tortor magna, in hendrerit sem. Donec pellentesque diam sed magna interdum tempus ullamcorper metus ullamcorper. Suspendisse pulvinar lobortis elit a fermentum. Pellentesque aliquam suscipit gravida. </p>
                     </div>
                  </div>
                  ...
                  <div>
                      ...
                      <div>
                      <p>Integer venenatis nunc lorem, ut placerat sem. Praesent lacus dolor, iaculis nec blandit vel, faucibus in orci. Curabitur fringilla tincidunt leo in hendrerit. Phasellus elit nulla, commodo et interdum sit amet, sollicitudin nec mi. Integer ac dignissim neque. Cras vestibulum, eros at gravida blandit, risus nulla placerat dui, eget tristique neque neque sodales lectus. Integer id elit magna, vitae congue enim. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Vivamus et sapien sed tellus dignissim porttitor. Phasellus ornare mi egestas sem facilisis porta. Praesent luctus mi id leo mattis euismod. Cras at erat ante, at pellentesque arcu. </p>
                      </div>
                  </div>
        ...
        <section class="one_fourth last">
           ...
           <section class="content_box content_box_black">
                <div class="inside">
                    ...
                    <p>Nam dui erat, auctor a, dignissim quis, sollicitudin eu, felis. Pellentesque nisi urna, interdum eget, sagittis et.</p>
                    <a href="#" class="button orange" target="_self"><span>Get a Free Quote</span></a>
                </div>
           </section>
           <br />
