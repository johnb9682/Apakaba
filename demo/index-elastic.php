...
<head>
  ...
  <link rel="stylesheet" href="css/elastic.css" type="text/css" media="screen" />
  <noscript><link rel="stylesheet" type="text/css" href="css/elastic-noscript.css" /></noscript>
...
<div id="container">
    ...
    <section id="banner-container">
    	<section class="banner_container_fix">
             ...
             <div class="banner_container_fix_elastic">
             <div id="ei-slider" class="ei-slider">
                    <ul class="ei-slider-large">
                        <li>
                            <img src="images/elastic/large/1.jpg" alt="image01" />
                            <div class="ei-title">
                                <h2>Creative</h2>
                                <h3>Duet</h3>
                            </div>
                        ...
                        <li>
                            <img src="images/elastic/large/2.jpg" alt="image02" />
                            <div class="ei-title">
                                <h2>Beauty</h2>
                                <h3>Nova</h3>
                            </div>
                        ...
                        <li>
                            <img src="images/elastic/large/3.jpg" alt="image03"/>
                            <div class="ei-title">
                                <h2>Pre Made</h2>
                                <h3>Skins</h3>
                            </div>
                        ...
                        <li>
                            <img src="images/elastic/large/4.jpg" alt="image04"/>
                            <div class="ei-title">
                                <h2>Unique</h2>
                                <h3>Clean</h3>
                            </div>
                    ...
                    <ul class="ei-slider-thumbs">
                        ...
                        <li><a href="#">Slide 1</a><img src="images/elastic/thumbs/1.jpg" alt="thumb01" /></li>
                        <li><a href="#">Slide 2</a><img src="images/elastic/thumbs/2.jpg" alt="thumb02" /></li>
                        <li><a href="#">Slide 3</a><img src="images/elastic/thumbs/3.jpg" alt="thumb03" /></li>
                        <li><a href="#">Slide 4</a><img src="images/elastic/thumbs/4.jpg" alt="thumb04" /></li>
                    </ul><!-- ei-slider-thumbs -->
                </div><!-- ei-slider -->
                </div><!-- /.banner_container_fix_elastic -->
                ...
                <td style="width:440px;">
                	<h2>Nova give you a choice and transform to your needs.</h2>
                      <ul>
                        ...
                        <li>Responsive Layouts (optional)</li>
                        <li>3 Layout Options</li>
                        <li>Unlimited Colors</li>
                        <li>10 Pre-made Skins</li>
...
pre made theme skins and easy re-skinning capabilities. <a href="">Get Nova Now &rarr;</a>
                ...
                <section class="footer_widget_14">
                    ...
                    <ul>
						...
						<li><a href="">+  Design Agency Home </a></li>
                        <li><a href="">+  Product Home Page </a></li>
                        <li><a href="">+  Photographer Home </a></li>
                        <li><a href="">+  Blogger Home Page </a></li>
					</ul>
                    </article>
                ...
                <section class="footer_widget_14">
                    ...
                    <article>
                    <p>
                    Company Details LTD.<br />
                    32-800 Brzesko<br />
                    Gracja 34/45<br /><br />
                    phone: 056 231 234<br />
                    fax: 056 231 234<br />
                    <p>
                    </article>
                </section><!-- /.footer_widget_14 -->
...
-------------------------------*/
  ...
  <script type="text/javascript" src="js/libs/jquery.eislideshow.js"></script>
