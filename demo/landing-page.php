...
<div id="container">
   ...
   <section class="page_title_container">
    <section class="page_title">
        <h1>This is Nice Landing Page</h1>
        <h2>Customize this page as you wish</h2>
    </section><!-- /.page_title -->
	...
	<section id="content-container">
    	<section class="content_container_fix">
             ...
             <section class="full_width no_margin">  
                ...
                <section class="single_portfolio_slider" id="single_portfolio_slider">
                    <div class="slides_container">
                        <div><img src="images/banner/woman.jpg" width="940" height="499" alt="image" /></div>
                        <div> <a href="#"><img src="images/banner/flex-banner.jpg" width="940" height="499" alt="image" /></a></div>
                        <div><img src="images/banner/html5-banner.jpg" width="940" height="499" alt="image" /></div>
                        <div><a href="#"><img src="images/banner/skins-banner.jpg" width="940" height="499" alt="image" /></a> </div>
                     </div><!-- /.slides_container -->
                </section><!-- /.single_portfolio_slider -->
                
                <section class="divider_line"></section>
              
                <h3>Nam dui erat, auctor a, dignissim quis, sollicitudin eu, felis.</h3>
                ...
                <section class="one_half">
                 <h2>Vivamus libero lectus lacinia vel</h2>
                ...
                <section class="one_half last">
                      <p>Mauris porttitor ullamcorper augue. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Phasellus mattis tincidunt nibh. Cras orci urna, blandit id, pretium vel, aliquet ornare, felis. Maecenas scelerisque sem non nisl. Fusce sed lorem in enim dictum bibendum.sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p> <p>Phasellus mattis tincidunt nibh. Cras orci urna, blandit id, pretium vel, aliquet ornare, felis. Maecenas scelerisque sem non nisl. Fusce sed lorem in enim dictum bibendum.sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p> <p>Phasellus mattis tincidunt nibh. Cras orci urna, blandit id, pretium vel, aliquet ornare, felis. Maecenas scelerisque sem non nisl. Fusce sed lorem in enim dictum bibendum.sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                       <p>Mauris porttitor ullamcorper augue. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                </section><!-- /.one_half -->
