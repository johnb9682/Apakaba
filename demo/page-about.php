    ...
    <nav>
    	<section class="nav_fix">
            ...
            <ul class="main-menu">
                ...
                <li class="current_page_item"><a href="page-sidebar_left.php">Page Styles</a>
                  <ul>
    	...
    	<section class="content_container_fix">
             ...
             <section class="full_width">
                ...
                <section class="three_fourth content-left">
                	...
                	<h2>There are so many reasons to choose us, they needed their own page. Nam accumsan nisl vitae urna porttitor a rutrum. Curabitur pharetra magna faucibus magna laoreet sit amet suscipit tellus vulputate.</h2>
                     
					<p>
                        Nam accumsan nisl vitae urna porttitor a rutrum. Curabitur pharetra magna faucibus magna laoreet sit amet suscipit tellus vulputate. Mauris magna turpis, ullamcorper nec dictum vel, fringilla sed justo. Nulla non massa at lectus posuere consequat sed quis orci. Praesent aliquam posuere lacus mattis convallis. Phasellus vitae massa massa, vel accumsan nibh. Integer quis nibh velit, condimentum elementum massa.<br />
                        <img src="images/image-sample.png" class="float-left" alt="image" />
                        Nunc tortor mauris, porta at accumsan in, venenatis nec orci. Proin velit lorem, tincidunt ut sagittis vitae, porttitor ac ligula. Quisque urna magna, vulputate at consectetur malesuada, vestibulum at purus. Vivamus libero lectus, fermentum ut lacinia vel, commodo quis quam.
                        Nunc tortor mauris, porta at accumsan in, venenatis nec orci. Proin velit lorem, tincidunt ut sagittis vitae, porttitor ac ligula. Quisque urna magna, vulputate at consectetur malesuada, vestibulum at purus. Vivamus libero lectus, fermentum ut lacinia vel, commodo quis quam.
                        Nunc tortor mauris, porta at accumsan in, venenatis nec orci. Proin velit lorem, tincidunt ut sagittis vitae, porttitor ac ligula. Quisque urna magna, vulputate at consectetur malesuada, vestibulum at purus. Vivamus libero lectus, fermentum ut lacinia vel, commodo quis quam.
                        Nunc tortor mauris, porta at accumsan in, venenatis nec orci. Proin velit lorem, tincidunt ut sagittis vitae, porttitor ac ligula. Quisque urna magna, vulputate at consectetur malesuada, vestibulum at purus. Vivamus libero lectus, fermentum ut lacinia vel, commodo quis quam.
                      </p>
                      <h2>Vivamus libero lectus, fermentum ut lacinia vel,</h2>
                        
                    <div id="tabs">
                        <ul>
                            <li><a href="#tabs-1">Who We Are ?</a></li>
                            <li><a href="#tabs-2">Our Approach</a></li>
                            <li><a href="#tabs-3">Our Mission</a></li>
                            <li><a href="#tabs-4">Methodology</a></li>
                        </ul>
                        
                        <div id="tabs-1">
                        <h4>Mauris porttitor ullamcorper augue. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</h4>
                         <img src="images/team_man_small.jpg" class="float-left" alt="image" /> <p>Nam dui erat, auctor a, dignissim quis, sollicitudin eu, felis. Pellentesque nisi urna, interdum eget, sagittis et, consequat vestibulum, lacus. Mauris porttitor ullamcorper augue. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                        <p>Nam dui erat, auctor a, dignissim quis, sollicitudin eu, felis. Pellentesque nisi urna, interdum eget, sagittis et, consequat vestibulum, lacus. Mauris porttitor ullamcorper augue. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                        </div>
                        
                        <div id="tabs-2">
                        <h4>Our Approach</h4>
                        <p>Phasellus mattis tincidunt nibh. Cras orci urna, blandit id, pretium vel, aliquet ornare, felis. Maecenas scelerisque sem non nisl. Fusce sed lorem in enim dictum bibendum.sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                        ...
                        <div id="tabs-3">
                        <h4>Our Mission</h4>
                        <p>Mauris porttitor ullamcorper augue. Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Phasellus mattis tincidunt nibh. Cras orci urna, blandit id, pretium vel, aliquet ornare, felis. Maecenas scelerisque sem non nisl. Fusce sed lorem in enim dictum bibendum.sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p> <p>Phasellus mattis tincidunt nibh. Cras orci urna, blandit id, pretium vel, aliquet ornare, felis. Maecenas scelerisque sem non nisl. Fusce sed lorem in enim dictum bibendum.sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p> <p>Phasellus mattis tincidunt nibh. Cras orci urna, blandit id, pretium vel, aliquet ornare, felis. Maecenas scelerisque sem non nisl. Fusce sed lorem in enim dictum bibendum.sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
                        </div>	
                    ...
                    <h3>Meet a Team</h3>
                     <p>
                        Nam accumsan nisl vitae urna porttitor a rutrum. Curabitur pharetra magna faucibus magna laoreet sit amet suscipit tellus vulputate. Mauris magna turpis, ullamcorper nec dictum vel, fringilla sed justo. Nulla non massa at lectus posuere consequat sed quis orci. Praesent aliquam posuere lacus mattis convallis. Phasellus vitae massa massa, vel accumsan nibh. Integer quis nibh velit, condimentum elementum massa. Nunc tortor mauris, porta at accumsan in, venenatis nec orci. Proin velit lorem, tincidunt ut sagittis vitae, porttitor ac ligula. Quisque urna magna, vulputate at consectetur malesuada, vestibulum at purus. Vivamus libero lectus, fermentum ut lacinia vel, commodo quis quam.
                      </p>
                      <br />
                     ...
                     <td>   
                          <section class="team_box">
                            ...
                            <h4>Jonathan Doe</h4>
                            <small>Managin Director</small>
                            <p>Curabitur ut lacus non nisl bibendum vestibulum at id orci. Sed scelerisque ultricies dapibus.</p>
                          </section><!-- /.team_box -->
                      </td>
                     <td>   
                          <section class="team_box">
                      ...
                      <td>  
                        ...
                        <p>
                        Nam sodales, lectus sed vulputate rhoncus, magna leo mollis tellus, quis commodo lectus enim eu ante. Nam consequat sagittis dui sed consequat. Nullam mollis metus ac leo sodales et eleifend lectus elementum. Praesent pretium, orci eget porttitor suscipit, elit sem iaculis arcu, sed porttitor felis orci ut orci. Vestibulum dictum, quam ac laoreet tincidunt, est lorem faucibus sapien, sit amet pulvinar dolor libero sit amet massa. Suspendisse potenti. Vivamus id volutpat dolor. Praesent porttitor pretium accumsan. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Nulla vel erat nec odio consectetur faucibus. Morbi eget erat orci, et laoreet ante. Vivamus risus sem, vehicula sit amet iaculis et, accumsan ut eros.
                        </p>
                ...
                <section class="one_fourth last">
                 	...
                 	<section class="widget">
                    	<h3>Page Menu</h3>
                        <ul class="menu">
                        	<li><a href="">Menu Item 1/ Subpage</a></li>
                        	<li><a href="">Menu Item 2/ Subpage</a></li>
                        	<li><a href="">Menu Item 3/ Subpage</a></li>
                        	<li><a href="">Menu Item 4/ Subpage</a></li>
                        	<li><a href="">Menu Item 5/ Subpage</a></li>
                        	<li><a href="">Menu Item 6/ Subpage</a></li>
                        </ul>
                    </section><!-- /.widget -->
                 
                 	<section class="widget">
                    	<h3>This Is Text Widget</h3>
                        <p> Vivamus vitae lectus non orci pretium vestibulum nec commodo metus. Phasellus egestas, metus eget convallis fermentum, nisi dui hendrerit felis, a convallis magna risus nec eros. Cras elementum viverra metus. Nunc vitae neque sed augue interdum lobortis in id velit. </p>
                        <a href="" class="button orange"><span>Read More</span></a>
                    </section><!-- /.widget -->	
                    
                    <section class="widget">
                    	<h3>Recent Work</h3>
                        <ul class="grid">
                        	<li><a href=""><img src="images/samples/work_mini_1.jpg" alt="image" /></a></li>
                        	<li><a href=""><img src="images/samples/work_mini_2.jpg" alt="image"  /></a></li>
                        	<li class="last"><a href=""><img src="images/samples/work_mini_3.jpg" alt="image"  /></a></li>
                        	<li><a href=""><img src="images/samples/work_mini_4.jpg" alt="image"  /></a></li>
                        	<li><a href=""><img src="images/samples/work_mini_5.jpg" alt="image"  /></a></li>
                        	<li class="last"><a href=""><img src="images/samples/work_mini_6.jpg" alt="image"  /></a></li>
                        </ul>
                   ...
                   <section class="widget">
                        ...
                        <ul class="list">
                        	<li>
                            <a href="" class="thum"><img src="images/samples/work_mini_1.jpg" alt="image"  /></a>
                            <a href="" class="recent_post_title">This is a Right Sidebar Post Example Title</a>
                            <span class="recent_post_date">on 01-27-2012</span>
                            </li>
                        	<li>
                            <a href="" class="thum"><img src="images/samples/work_mini_2.jpg" alt="image"  /></a>
                            <a href="" class="recent_post_title">This is a Right Sidebar Post Example Title</a>
                            <span class="recent_post_date">on 01-27-2012</span>
                            </li>
                        	<li>
                            <a href="" class="thum"><img src="images/samples/work_mini_3.jpg" alt="image"  /></a>
                            <a href="" class="recent_post_title">This is a Right Sidebar Post Example Title</a>
                            <span class="recent_post_date">on 01-27-2012</span>
                            </li>
                        </ul>
