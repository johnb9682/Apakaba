...
<div id="container">
    ...
    <section class="page_title">
        <h1>Page - No Sidebar</h1>
        <h2>A page with no sidebar</h2>
    </section><!-- /.page_title -->
	...
	<section id="content-container">
    	<section class="content_container_fix">
             ...
             <section class="full_width no_margin">
                      ...
                      <img src="images/banner/flex-banner.jpg" width="940" height="499" alt="image" />
                      <br /><br /><br />
					  ...
					  <p>
                        ...
                        <h4>Curabitur pharetra magna faucibus magna laoreet sit amet suscipit tellus vulputate.</h4>
                        <p>
                        Nam accumsan nisl vitae urna porttitor a rutrum. Curabitur pharetra magna faucibus magna laoreet sit amet suscipit tellus vulputate. Mauris magna turpis, ullamcorper nec dictum vel, fringilla sed justo. Nulla non massa at lectus posuere consequat sed quis orci. Praesent aliquam posuere lacus mattis convallis. Phasellus vitae massa massa, vel accumsan nibh. Integer quis nibh velit, condimentum elementum massa. Nunc tortor mauris, porta at accumsan in, venenatis nec orci. Proin velit lorem, tincidunt ut sagittis vitae, porttitor ac ligula. Quisque urna magna, vulputate at consectetur malesuada, vestibulum at purus. Vivamus libero lectus, fermentum ut lacinia vel, commodo quis quam.
                        </p>
                     ...
                     <h2>Vivamus libero lectus, fermentum ut lacinia vel,</h2>
                      ...
                      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam pharetra aliquet leo. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Aenean ac ullamcorper nisl. Proin a felis dui, eu aliquam eros. Curabitur scelerisque dictum mattis. Praesent ornare nisl at erat malesuada non varius nibh interdum. Donec risus lectus, congue sit amet consectetur non, adipiscing eu lectus.</p>
                          
                      <blockquote class="blockquote">
                          <q>Nunc eget tellus tortor, in luctus lacus. Nulla in orci id nisi sagittis cursus. Sed ac mauris sed tellus blandit ultricies. Donec at suscipit nulla. Donec a mauris turpis, sed tincidunt diam. Phasellus eget lorem eu enim ultrices tempor malesuada quis nisl. Sed congue pharetra eleifend. Mauris eget purus ac mi rutrum mattis. </q>
                      </blockquote>
                      
                      <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam pharetra aliquet leo. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Aenean ac ullamcorper nisl. Proin a felis dui, eu aliquam eros. </p>
