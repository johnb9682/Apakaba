...
<div id="container">
    ...
    <nav>
    	<section class="nav_fix">
            ...
            <ul class="main-menu">
                ...
                <li class="current_page_item"><a href="portfolio-4columns-filter.php">Portfolio / Gallery</a>
                  <ul>
    ...
    <section class="page_title">
        <h1>Portfolio Page with Filters</h1>
        <h2>Protfolio Showcase</h2>
    </section><!-- /.page_title -->
	...
	<section id="content-container">
    	<section class="content_container_fix">
            ...
            <section class="full_width portfolio">
               
                <section id="portfolio-options" class="clearfix">
                    <ul id="filterOptions" class="option-set filter clearfix" >
                      			<li class="active all-projects"><a href="" >All Projects</a></li>
								<li class="branding"><a href="" title="Branding projects">Branding</a> </li>
                                <li class="web"><a href="" title="Web projects">Web</a> </li>
                                <li class="design"><a href="" title="design projects">Design</a> </li>
                                <li class="icons"><a href="" title="Icons projects">Icons</a> </li>
                                <li class="UI"><a href="" title="UI projects">UI Elements</a> </li>	
                                <li class="video"><a href="" title="Video projects">Video</a> </li>	
                    </ul><!-- /#filterOptions -->
  				</section> <!-- #portfolio-options -->
  
               <div id="portfolio-container" class="filter-posts clearfix">
                
                          <section class="view_box view_box_1_1 element" data-type="icons UI" data-id="project-1" >
                          	  <div class="view view_move view_1_1">
                                  <img src="images/samples/big/work_thum_1.jpg" alt="image" />
                              ...
                              <article class="post_excerpt">
	                              ...
	                              <p>
		                              Maecenas ac urna at tellus euismod posuere. Maecenas tincidunt posuere velit, non posuere tortor lobortis blandit. Suspendisse ac magna lacus, id commodo tortor. Integer quis ante pulvinar risus feugiat ullamcorper eu non elit. Fusce dapibus interdum tortor vitae venenatis. Suspendisse diam nisi, semper non cursus ut, ultricies eget erat. Aliquam erat volutpat.     
		                           </p>
		                           <a href="" class="button black"><span>View Project</span></a>
                               </article>
                          </section><!-- /.view_box --> 
                          
                           
                          <section class="view_box view_box_1_1 element " data-type="UI Web" data-id="project-2" >
                          	  <div class="view view_move view_1_1">
                                  <img src="images/samples/big/work_thum_2.jpg" alt="image" />
                           ...
                           <section class="view_box view_box_1_1 element" data-type="design video" data-id="project-3" >
                              <div class="view view_move view_1_1">
                                  <img src="images/samples/big/work_thum_3.jpg" alt="image" />
                          ...
                          <section class="view_box view_box_1_1  element" data-type="branding" data-id="project-4" >
                          	<div class="view view_move view_1_1">
                                  <img src="images/samples/big/work_thum_4.jpg" alt="image" />
                           ...
                           <section class="view_box view_box_1_1 element " data-type="icons web" data-id="project-5" >
                          	  <div class="view view_move view_1_1">
                                  <img src="images/samples/big/work_thum_5.jpg" alt="image" />
                           ...
                           <section class="view_box view_box_1_1 element " data-type="UI" data-id="project-6" >
                              <div class="view view_move view_1_1">
                                  <img src="images/samples/big/work_thum_6.jpg" alt="image" />
                          ...
                          <section class="view_box view_box_1_1  element" data-type="Web design" data-id="project-7" >
                          	<div class="view view_move view_1_1">
                                  <img src="images/samples/big/work_thum_7.jpg" alt="image" />
                                  <a class="mask" href="portfolio-single-video-full.php">
                                     <span class="thumicon link-thumicon"></span>
                                  </a>
                              </div> <!-- /.view -->   
                              <article class="post_excerpt">
                          ...
                          <section class="view_box view_box_1_1  element" data-type="icons web" data-id="project-8" >
                          	<div class="view view_move view_1_1">
                                  <img src="images/samples/big/work_thum_8.jpg" alt="image" />
                          ...
                          <section class="view_box view_box_1_1 element " data-type="icons" data-id="project-9" >
                          	  <div class="view view_move view_1_1">
                                  <img src="images/samples/big/work_thum_9.jpg" alt="image" />
                                  <a class="mask" href="images/samples/big/work_thum_9.jpg" data-rel="prettyPhoto">
                                     <span class="thumicon magnifier-thumicon"></span>
                                  </a>
                              </div><!-- /.view -->   
                              <article class="post_excerpt">   
                              	  <h3><a href="">Halloween Pumpkin</a></h3>
                           ...
                           <section class="view_box view_box_1_1 element" data-type="branding" data-id="project-10" >
                              <div class="view view_move view_1_1">
                                  <img src="images/samples/big/work_thum_10.jpg" alt="image" />
                                  <a class="mask" href="images/samples/big/work_thum_10.jpg" data-rel="prettyPhoto">
                                     <span class="thumicon magnifier-thumicon"></span>
                                  </a>
                              </div><!-- /.view -->   
                              <article class="post_excerpt">    
                              	  <h3><a href="">Leather Business Card</a></h3>
                              	  <span class="meta">Branding &amp; Identity</span>
	                              <p>
		                              Maecenas ac urna at tellus euismod posuere. Maecenas tincidunt posuere velit, non posuere tortor lobortis blandit. Suspendisse ac magna lacus, id commodo tortor. Integer quis ante pulvinar risus feugiat ullamcorper eu non elit. Fusce dapibus interdum tortor vitae venenatis. Suspendisse diam nisi, semper non cursus ut, ultricies eget erat. Aliquam erat volutpat.     
		                           </p>
                          ...
                          <section class="view_box view_box_1_1  element" data-type="web icons" data-id="project-11" >
                          	<div class="view view_move view_1_1">
                                  <img src="images/samples/big/work_thum_11.jpg" alt="image" />
                                  <a class="mask" href="portfolio-single-images-2columns.php">
                                     <span class="thumicon link-thumicon"></span>
                                  </a>
                              </div><!-- /.view -->   
                              <article class="post_excerpt">     
                              	  <h3><a href="">Map Pop Up Window</a></h3>
                              	  <span class="meta">Web &amp; Icons</span>
	                              <p>
		                              Maecenas ac urna at tellus euismod posuere. Maecenas tincidunt posuere velit, non posuere tortor lobortis blandit. Suspendisse ac magna lacus, id commodo tortor. Integer quis ante pulvinar risus feugiat ullamcorper eu non elit. Fusce dapibus interdum tortor vitae venenatis. Suspendisse diam nisi, semper non cursus ut, ultricies eget erat. Aliquam erat volutpat.     
		                           </p>
                           ...
                           <section class="view_box view_box_1_1 element " data-type="icons" data-id="project-12" >
                          	  <div class="view view_move view_1_1">
                                  <img src="images/samples/big/work_thum_12.jpg" alt="image" />
                                  <a class="mask" href="images/samples/big/work_thum_12.jpg" data-rel="prettyPhoto">
                                     <span class="thumicon magnifier-thumicon"></span>
                                  </a>
                              </div><!-- /.view -->   
                              <article class="post_excerpt"> 
                              	  <h3><a href="">Minimalist Battery Icons</a></h3>
                              	  <span class="meta">Icons</span>
	                              <p>
		                              Maecenas ac urna at tellus euismod posuere. Maecenas tincidunt posuere velit, non posuere tortor lobortis blandit. Suspendisse ac magna lacus, id commodo tortor. Integer quis ante pulvinar risus feugiat ullamcorper eu non elit. Fusce dapibus interdum tortor vitae venenatis. Suspendisse diam nisi, semper non cursus ut, ultricies eget erat. Aliquam erat volutpat.     
		                           </p>
                           ...
                           <section class="view_box view_box_1_1 element " data-type="video" data-id="project-13" >
                              <div class="view view_move view_1_1">
                                  <img src="images/samples/big/work_thum_13.jpg" alt="image" />
                                  <a class="mask" href="http://www.youtube.com/watch?v=kh29_SERH0Y?rel=0" data-rel="prettyPhoto">
                                     <span class="thumicon video-thumicon"></span>
                                  </a>
                              </div><!-- /.view -->   
                              <article class="post_excerpt">
                              	  <h3><a href="">Stylish Music Player</a></h3>
                          ...
                          <section class="view_box view_box_1_1  element" data-type="icons" data-id="project-14" >
                          	<div class="view view_move view_1_1">
                                  <img src="images/samples/big/work_thum_14.jpg" alt="image" />
                                  <a class="mask" href="portfolio-single-slider-2columns.php">
                                     <span class="thumicon link-thumicon"></span>
                                  </a>
                              </div> <!-- /.view -->   
                              <article class="post_excerpt"> 
                              	  <h3><a href="">Weather Icons</a></h3>
                              	  <span class="meta">Icons</span>
	                              <p>
		                              Maecenas ac urna at tellus euismod posuere. Maecenas tincidunt posuere velit, non posuere tortor lobortis blandit. Suspendisse ac magna lacus, id commodo tortor. Integer quis ante pulvinar risus feugiat ullamcorper eu non elit. Fusce dapibus interdum tortor vitae venenatis. Suspendisse diam nisi, semper non cursus ut, ultricies eget erat. Aliquam erat volutpat.     
		                           </p>
                          ...
                          <section class="view_box view_box_1_1  element" data-type="UI" data-id="project-15" >
                          	<div class="view view_move view_1_1">
                                  <img src="images/samples/big/work_thum_15.jpg" alt="image" />
                                  <a class="mask" href="portfolio-single-video-2columns.php">
                                     <span class="thumicon link-thumicon"></span>
                                  </a>
                              </div>  <!-- /.view -->   
                              <article class="post_excerpt">
                              	  <h3><a href="">Plastic Control Knobs</a></h3>
                              	  <span class="meta">UI Elements</span>
	                              <p>
		                              Maecenas ac urna at tellus euismod posuere. Maecenas tincidunt posuere velit, non posuere tortor lobortis blandit. Suspendisse ac magna lacus, id commodo tortor. Integer quis ante pulvinar risus feugiat ullamcorper eu non elit. Fusce dapibus interdum tortor vitae venenatis. Suspendisse diam nisi, semper non cursus ut, ultricies eget erat. Aliquam erat volutpat.     
		                           </p>
                          ...
                          <section class="view_box view_box_1_1  element" data-type="design web" data-id="project-16" >
                          	<div class="view view_move view_1_1">
                                  <img src="images/samples/big/work_thum_16.jpg" alt="image" />
                                  <a class="mask"  href="images/samples/big/work_thum_16.jpg" data-rel="prettyPhoto">
                                     <span class="thumicon magnifier-thumicon"></span>
                                  </a>
                              </div>  <!-- /.view -->   
                              <article class="post_excerpt">
                              	  <h3><a href="">Polished Paper Stickers</a></h3>
                              	  <span class="meta">Web &amp; Design</span>
	                              <p>
		                              Maecenas ac urna at tellus euismod posuere. Maecenas tincidunt posuere velit, non posuere tortor lobortis blandit. Suspendisse ac magna lacus, id commodo tortor. Integer quis ante pulvinar risus feugiat ullamcorper eu non elit. Fusce dapibus interdum tortor vitae venenatis. Suspendisse diam nisi, semper non cursus ut, ultricies eget erat. Aliquam erat volutpat.     
		                           </p>
                          ...
                          <section class="view_box view_box_1_1  element" data-type="icons web" data-id="project-17" >
                          	<div class="view view_move view_1_1">
                                  <img src="images/samples/big/work_thum_17.jpg" alt="image" />
                                  <a class="mask"  href="images/samples/big/work_thum_17.jpg" data-rel="prettyPhoto">
                                     <span class="thumicon magnifier-thumicon"></span>
                                  </a>
                              </div><!-- /.view -->   
                              <article class="post_excerpt">  
                             	  <h3><a href="">Pretty Envelope Icon</a></h3>
                             	  <span class="meta">Web &amp; Icons</span>
	                              <p>
		                              Maecenas ac urna at tellus euismod posuere. Maecenas tincidunt posuere velit, non posuere tortor lobortis blandit. Suspendisse ac magna lacus, id commodo tortor. Integer quis ante pulvinar risus feugiat ullamcorper eu non elit. Fusce dapibus interdum tortor vitae venenatis. Suspendisse diam nisi, semper non cursus ut, ultricies eget erat. Aliquam erat volutpat.     
		                           </p>
...
pre made theme skins and easy re-skinning capabilities. <a href="">Get Nova Now &rarr;</a>
  ...
  <script src="js/pre-scripts.js"></script>
