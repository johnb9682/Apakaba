...
<div id="container">
    ...
    <nav>
    	<section class="nav_fix">
            ...
            <ul class="main-menu">
                ...
                <li class="current_page_item"><a href="pricing-tables.php">Pricing</a></li>
    ...
    <section class="page_title">
        ...
        <h2>Our great looking prices options </h2>
    </section><!-- /.page_title -->
	...
	<section id="content-container">
    	<section class="content_container_fix">
            ...
            <section class="full_width">
                ...
                <section class="one_third">
                    <div class="pricing-box ">
                        ...
                        <div class="pricing-box-content">
                            <ul>
                                <li> Phasellus nunc augue, volutpat sed tristique sit amet.</li>
                                <li>Lorem ipsum dolor sit amet</li>
                                <li>Ut id dolor id mauris bibendum consectetur</li>
                                <li>Mauris bibendum consectetur</li>
                            </ul>
                        </div>
                        <br />
                ...
                <section class="one_third">
                    <div class="pricing-box box-dark">
                        <div class="pricing-box-head">
                ...
                <div class="price-table four-columns">
                  <div class="price-column">
                    <ul>
                      <li class="thead">Basic Package</li>
                      <li class="price">$ 13.95 <span>/ month</span></li>
                  ...
                  <div class="price-column price-column-dark">
                    <ul>
                      ...
                      <li class="price">$ 17.95 <span>/ month</span></li>
                  ...
                  <div class="price-column highlight">
                    <ul>
                      ...
                      <li class="price">$ 19.95 <span>/ month</span></li>
                  ...
                  <div class="price-column price-column-dark">
                    <ul>
                      ...
                      <li class="price">$ 29.95 <span>/ month</span></li>
