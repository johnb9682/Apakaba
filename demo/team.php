...
<div id="container">
    ...
    <section class="page_title">
        <h1>Our Team</h1>
        <h2>Our success - people we employ</h2>
    </section><!-- /.page_title -->
	...
	<section id="content-container">
    	<section class="content_container_fix">
            ...
            <section class="full_width">
              ...
              <h5>Phasellus eros sem, porta a imperdiet id, ultricies id diam. Nam quam urna, gravida a convallis nec, aliquam sit amet magna. Donec varius quam non lorem viverra vitae posuere enim sodales. Curabitur ut lacus non nisl bibendum vestibulum at id orci. Sed scelerisque ultricies dapibus.</h5>
